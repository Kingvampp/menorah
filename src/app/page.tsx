...
import Earring3D from '@/components/Earring3D';
...
export default function Home() {
  ...
  const [menorahX, setMenorahX] = useState(0); // Menorah starts at center

  useEffect(() => {
    // Text slide animation - starts first
    const textTimer = setTimeout(() => {
      setTextSlideX(0); // Slide text to final position
    }, 1000); // Text slides in after 1 second
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-light text-gray-900 leading-none tracking-tight">
                LUXURY<br />
                REDEFINED
              </h2>
            </div>
            ...
            {/* Description */}
            <p className="text-base sm:text-lg text-gray-600 max-w-md leading-relaxed font-light mx-auto lg:mx-0">
              Experience the perfect fusion of traditional craftsmanship and contemporary design. Each piece tells a story of elegance, precision, and timeless beauty.
            </p>

            {/* CTA Button */}
            <Link 
              href="/products" 
              className="border border-gray-800 text-gray-800 px-8 sm:px-12 py-3 sm:py-4 hover:bg-gray-800 hover:text-white transition-all duration-300 flex items-center gap-3 inline-block font-light tracking-widest uppercase text-sm mx-auto lg:mx-0"
            >
              Discover Luxury
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          >
            <div className="space-y-2">
              <h1 className="text-xl sm:text-2xl md:text-3xl font-light tracking-widest text-gray-800 uppercase">
                For Her
              </h1>
            </div>
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-md leading-relaxed font-light mx-auto lg:ml-auto lg:mr-0">
              Discover our exquisite collection of handcrafted jewelry designed for the modern woman. From delicate earrings to statement necklaces, each piece celebrates feminine elegance and timeless beauty.
            </p>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <Suspense fallback={null}>
                <Earring3D 
                  modelPath="/models/for_him.glb"
                  canvasId="for-him-canvas"
                />
              </Suspense>
            </Canvas>
          </div>
