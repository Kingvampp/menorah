        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-gray-900 leading-tight mb-4" style={{ fontFamily: '"Times New Roman", "Times", serif', fontWeight: '400', letterSpacing: '0.05em' }}>
                  Send us a Message
                </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-gray-900 mb-2 font-light tracking-wide uppercase">
                      Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-sm focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-300 font-light"
                      placeholder="Your full name"
                    />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-gray-900 mb-2 font-light tracking-wide uppercase">
                      Email Address *
                    </label>
                    <input
                      type="email"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="phone" className="block text-sm font-medium text-gray-900 mb-2 font-light tracking-wide uppercase">
                      Phone Number
                    </label>
                    <input
                      type="tel"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-gray-900 mb-2 font-light tracking-wide uppercase">
                      Subject *
                    </label>
                    <select
                      id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-gray-900 mb-2 font-light tracking-wide uppercase">
                    Message *
                  </label>
                  <textarea
                    id="message"
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-sm focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-300 resize-none font-light"
                    placeholder="Tell us about your vision, questions, or how we can help you..."
                  />
                </div>

                <button
                  type="submit"
                  className="w-full border border-gray-800 text-gray-800 px-8 sm:px-12 py-3 sm:py-4 hover:bg-gray-800 hover:text-white transition-all duration-300 flex items-center gap-3 inline-block font-light tracking-widest uppercase text-sm"
                >
                  Send Message
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-base sm:text-lg text-gray-600 font-light">
                  Experience our collection in person at our flagship showroom in Yangon, Myanmar.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-light text-gray-900 tracking-wide uppercase" style={{ fontFamily: '"Times New Roman", "Times", serif', fontWeight: '400', letterSpacing: '0.05em' }}>Address</h3>
                ...
                <div className="flex items-start space-x-4">
                  <div className="text-2xl">🕒</div>
                  <div>
                    <h3 className="text-lg font-light text-gray-900 tracking-wide uppercase" style={{ fontFamily: '"Times New Roman", "Times", serif', fontWeight: '400', letterSpacing: '0.05em' }}>Hours</h3>
                    <p className="text-gray-600 font-light">
                ...
                <div className="flex items-start space-x-4">
                  <div className="text-2xl">📞</div>
                  <div>
                    <h3 className="text-lg font-light text-gray-900 tracking-wide uppercase" style={{ fontFamily: '"Times New Roman", "Times", serif', fontWeight: '400', letterSpacing: '0.05em' }}>Phone</h3>
                    <p className="text-gray-600 font-light">
                      +95 1 234 5678<br />
                      +95 9 123 456 789
                    </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-light text-gray-900 tracking-wide uppercase" style={{ fontFamily: '"Times New Roman", "Times", serif', fontWeight: '400', letterSpacing: '0.05em' }}>Email</h3>
                    <p className="text-gray-600 font-light">
                      info@menorahdiamond.com<br />
                      custom@menorahdiamond.com
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Map Placeholder */}
              <div className="bg-gray-50 rounded-sm p-8 h-64 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-4xl mb-2">🗺️</div>
                  <p className="text-gray-600 font-light">Interactive Map</p>
                  <p className="text-sm text-gray-500 font-light">Click to view directions</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-base sm:text-lg text-gray-600 font-light">
              Common questions about our jewelry and services
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-sm border border-gray-200 overflow-hidden">
              ...
              >
                <h3 className="text-lg font-light text-gray-900 tracking-wide uppercase" style={{ fontFamily: '"Times New Roman", "Times", serif', fontWeight: '400', letterSpacing: '0.05em' }}>
                  Do you offer custom design services?
                </h3>
                <svg 
                  className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${openFAQ === 0 ? 'rotate-180' : ''}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
              ...
              <div className={`overflow-hidden transition-all duration-300 ${openFAQ === 0 ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                <div className="px-6 pb-4">
                  <p className="text-gray-600 font-light leading-relaxed">
                    Yes! We specialize in custom jewelry design. Our master craftsmen work closely with you to create unique pieces that reflect your personal style and requirements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-sm border border-gray-200 overflow-hidden">
              ...
              <div className={`overflow-hidden transition-all duration-300 ${openFAQ === 3 ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                <div className="px-6 pb-4">
                  <p className="text-gray-600 font-light leading-relaxed">
                    Absolutely! We provide comprehensive repair, cleaning, and maintenance services for all our jewelry pieces. We also offer a lifetime warranty on craftsmanship.
                  </p>
                </div>
              </div>
            </div>
